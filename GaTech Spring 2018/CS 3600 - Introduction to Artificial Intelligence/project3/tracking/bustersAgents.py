    ...
    def chooseAction(self, gameState):
        ...
        for ghost in ghostPos:
            ...
            if (distance < mindist) | (mindist == -1):
                ...
                closeGhostPos = ghost
        action = legal[0]
        mindist = self.distancer.getDistance(Actions.getSuccessor(pacmanPosition, action), closeGhostPos)
        for a in legal:
            if self.distancer.getDistance(Actions.getSuccessor(pacmanPosition, a), closeGhostPos) < mindist:
                action = a
                mindist = self.distancer.getDistance(Actions.getSuccessor(pacmanPosition, a), closeGhostPos)
        return action
