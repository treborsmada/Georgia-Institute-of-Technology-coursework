...
public class EditStudentActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter2 = new ArrayAdapter(this, android.R.layout.simple_spinner_item, Arrays.asList(ClassStanding.FRESHMAN, ClassStanding.SOPHOMORE, ClassStanding.JUNIOR, ClassStanding.SENIOR));
    ...
    protected void onAddPressed(View view) {
        ...
        _student.setClassStanding((ClassStanding) spinner2.getSelectedItem());
